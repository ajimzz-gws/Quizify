...
// Get student data and quiz attempts
$userId = $_SESSION['user_id'];

// Fetch student profile data
$student = $db->pdo->query("
    SELECT u.*, 
           JSON_UNQUOTE(u.student_data->'$.class') AS class
    FROM users u
    WHERE u.id = $userId
")->fetch(PDO::FETCH_ASSOC);

// Decode student_data JSON if it exists
...
$averageScore = $totalQuizzes > 0 ? 
    round(array_sum(array_column($attempts, 'score')) / $totalQuizzes, 1) : 0;
...
<meta name="description" content="Student Dashboard for Quizify - View your quiz attempts, scores, and stats."> 
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css">
<!-- <link rel="stylesheet" href="templates/dashboardStudent.css"> -->
...
<div class="min-h-screen flex items-center justify-center p-4">
  <div class="w-full max-w-6xl bg-white shadow-lg rounded-xl overflow-hidden flex flex-col">
    <!-- Header -->
      ...
      <aside class="w-full lg:w-64 bg-blue-700 p-6 text-white">
        ...
        <nav>
          <ul>
            ...
            <li class="mb-4">
              <select class="block w-full bg-blue-600 border border-blue-500 text-white py-2 px-4 pr-8 rounded-md leading-tight focus:outline-none focus:bg-blue-500 focus:border-blue-400">
          ...
          <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
            <thead>
              <tr class="bg-gray-100 border-b border-gray-200">
                <th class="py-3 px-4 text-left text-sm font-semibold text-gray-600 rounded-tl-lg">Subject</th>
                ...
                <th class="py-3 px-4 text-left text-sm font-semibold text-gray-600 rounded-tr-lg">Grade</th>
              </tr>
            </thead>
            <tbody>
